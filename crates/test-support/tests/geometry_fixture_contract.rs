...
const THREE_MF_FAILURES: [(&str, &str, &str); 35] = [
    (
        include_str!(
    ...
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_reflected_component_transform_rejection.json"
        ),
        "FIX-MESH-050",
        "THREE_MF_UNSUPPORTED_TRANSFORM",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_singular_component_transform_rejection.json"
        ),
        "FIX-MESH-051",
        "THREE_MF_UNSUPPORTED_TRANSFORM",
    ),
    (
        include_str!("../../../fixtures/expected/adversarial_3mf_non_finite_vertex_rejection.json"),
        "FIX-MESH-052",
        "THREE_MF_INVALID_NUMBER",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_degenerate_triangle_rejection.json"
        ),
        "FIX-MESH-053",
        "THREE_MF_DEGENERATE_TRIANGLE",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_empty_triangle_set_rejection.json"
        ),
        "FIX-MESH-054",
        "THREE_MF_UNSUPPORTED_MODEL_STRUCTURE",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_missing_vertex_coordinate_rejection.json"
        ),
        "FIX-MESH-055",
        "THREE_MF_INVALID_XML",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_out_of_range_triangle_index_rejection.json"
        ),
        "FIX-MESH-056",
        "THREE_MF_UNSUPPORTED_MODEL_STRUCTURE",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_vertex_limit_exceeded_rejection.json"
        ),
        "FIX-MESH-057",
    ...
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_duplicate_model_content_type_rejection.json"
        ),
        "FIX-MESH-063",
        "THREE_MF_INVALID_PACKAGE",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_missing_model_content_type_rejection.json"
        ),
        "FIX-MESH-064",
        "THREE_MF_INVALID_PACKAGE",
    ),
    (
        include_str!(
            "../../../fixtures/expected/adversarial_3mf_wrong_model_content_type_rejection.json"
        ),
        "FIX-MESH-065",
        "THREE_MF_INVALID_PACKAGE",
    ),
