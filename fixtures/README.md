...
`manifest.yaml` is authoritative for fixture provenance, hashes, classification, and expected-result files. Project redistribution licensing, domain-expert review, STEP/3MF fixtures, and representative machining parts remain required; do not manufacture questionable hand-written fixtures and call them representative.
