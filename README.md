...
| Rates and resources | Empty-on-install, user-owned rate cards; effective dating, scope resolution, approval state, pricing and rounding policies; durable schema-v2 Settings drafts for USD rates/pricing and one material/offer/stock/machine/runtime starter bundle; an additive bounded multi-entry catalog/review domain contract | Persisted resources are drafts and are not calculation authority; the multi-entry catalog is not yet persisted or exposed; PartProbe supplies no production rates |
...
2. Finish USE-2 by persisting and exposing the bounded multi-entry catalog and reviewed active-for-proposals selection through an authorized application boundary.
