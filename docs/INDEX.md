...
- **Next actions:** Continue TASK-003 with OS containment/resource limits, representative fixture evidence, and reproducible native builds; then execute TASK-004 mesh import, TASK-005 desktop/rate UX, TASK-006 persistence, and TASK-007 shop calibration in [backlog priority](07-delivery/backlog.md)
