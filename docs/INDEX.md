...
| Isolated geometry-worker IPC/crash/resource boundary | Bounded subprocess, consumed already-open supervisor grant, and fixed-name verified staging pass three OSes; final-component-safe local opening passes locally; application-service path authorization/parent containment, direct worker handles, and OS sandbox/resource enforcement pending | ADR-0005 and TASK-003 |
