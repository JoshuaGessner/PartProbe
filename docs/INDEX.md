...
| Isolated geometry-worker IPC/crash/resource boundary | Bounded subprocess, consumed already-open supervisor grant, and fixed-name verified staging pass three OSes; application resolver policy, direct worker handles, and OS sandbox/resource enforcement pending | ADR-0005 and TASK-003 |
