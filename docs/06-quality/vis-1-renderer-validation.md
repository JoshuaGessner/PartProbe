...
| Developer Tauri host tests | 48 passed; five configured native/package smokes remain ignored | The feature-gated adapter preserves exact contract-v11 parity, requests the exact display profile, rejects popup-builder/geometry-payload regressions, binds scene acceptance to the current selection, and clears stale source state |
