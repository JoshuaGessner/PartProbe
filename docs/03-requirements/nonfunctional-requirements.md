...
> **Related requirements:** REQ-NF-001–REQ-NF-022; SEC-001–SEC-014; UX-001–UX-045  
...
| REQ-NF-003 | Calculation results shall be reproducible from stored inputs and versions; authoritative currency shall not use binary floating point. | TEST-001 deterministic cross-platform golden tests | Draft |
...
| REQ-NF-009 | Approved revisions and audit events shall be append-preserving; re-analysis shall not overwrite approved human decisions. | TEST-006/007 audit tests | Draft |
...
| REQ-NF-017 | Missing, stale, conflicting, or low-quality capacity, availability, PMI, requirement, CAM, and learning evidence shall be explicit and shall not silently become a neutral/default value. | TEST-047, TEST-064, TEST-068, TEST-077, TEST-082, TEST-087 | Draft |
...
| REQ-NF-020 | Recalculation, comparison, learning, or algorithm upgrades shall never rewrite issued quotes, approved routings, prior model analyses, or historical actuals. | TEST-006, TEST-060, TEST-078, TEST-084 | Draft |
