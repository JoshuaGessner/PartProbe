...
| REQ-F-005 | The system shall calculate material mass and propose editable stock alternatives with allowances, removed volume, evidence, cost, and confidence. | TEST-002 calculation + TEST-003 geometry; partial GUI-2 composition and [VIS-4 headless candidate engine](../06-quality/use-3-stock-proposal-validation.md#vis-4-candidate-engine-evidence-2026-09-15); desktop editing/adoption and standard stock remain pending | Draft |
...
| REQ-F-010 | The system shall permit correction of every generated assumption or selected rate and preserve original/new values, actor, time, reason, authorization, and source versions. | TEST-006/014; VIS-4 preserves immutable original/previous/new stock and actor/time/reason in headless tests; authorization/adoption/session sequencing remain pending | Draft |
