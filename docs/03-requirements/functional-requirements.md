...
| REQ-F-005 | The system shall calculate material mass and propose editable stock alternatives with allowances, removed volume, evidence, cost, and confidence. | TEST-002 calculation + TEST-003 geometry; partial GUI-2 composition and [VIS-4 headless candidate adoption/evaluation](../06-quality/use-3-stock-proposal-validation.md#vis-4-candidate-adoption-evidence-2026-09-15); desktop editing/adoption and standard stock remain pending | Draft |
...
| REQ-F-010 | The system shall permit correction of every generated assumption or selected rate and preserve original/new values, actor, time, reason, authorization, and source versions. | TEST-006/014; VIS-4 headless tests preserve original/previous/new stock and actor/time/reason, enforce latest retained-session revisions, and pin separate review/adoption with unchanged baseline; authorization/audit and desktop composition remain pending | Draft |
