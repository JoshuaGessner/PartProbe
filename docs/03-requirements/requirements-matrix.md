...
| REQ-NF-001–022 | Nonfunctional requirements | ADRs, security, deployment, quality, replay and resource budgets | TEST-001/002/014, TEST-007, TEST-008, TEST-011–013, TEST-019–030, TEST-040–099 | TASK-001 and TASK-002 supply three-OS calculation, rate/policy replay, and missing-data evidence; broader gates remain planned |
...
| TEST-001–099 | Quality strategy and specialized plans | `docs/06-quality` | Self-audit + future executable suites | TEST-001 and partial TEST-002/014 pass locally and on Windows/Linux/macOS; TEST-003–099 otherwise remain planned |

Coverage means planned traceability, not completion. [TASK-001 evidence](../06-quality/task-001-validation.md) and [TASK-002 evidence](../06-quality/task-002-validation.md) are linked, but affected requirements remain incomplete until downstream UI, persistence, calibration, and approval gates pass.
