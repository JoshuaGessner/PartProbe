...
| REQ-F-021–024 | Detailed CAD/feature/setup requirements | geometry/feature engines and worker | TEST-021–039 | TASK-003 kernel-neutral contracts, explicit identity-bound verified-copy transport, capability-root local intake, worker-side source verification, and provisional STEP basic-property spike; direct-resource launch, authoritative analysis, and feature/setup evidence pending |
...
| REQ-NF-001–022 | Nonfunctional requirements | ADRs, security, deployment, quality, replay and resource budgets | TEST-001/002/014, TEST-007, TEST-008, TEST-011–013, TEST-019–030, TEST-040–099 | TASK-001/002 supply three-OS calculation, replay, and missing-data evidence; TASK-003 supplies partial TEST-008/011/019/021/023/030 evidence for a bounded worker, capability-root containment, explicit verified-copy transport, identity/hash/length/quota revalidation, deny-by-default authorization/audit, cancellation and forced termination, plus Apple Silicon byte-stream OCCT evidence. Post-checkpoint three-OS CI, direct-resource whitelisting, OS resource isolation, and broader gates remain pending |
...
| SEC-001–014 | Security model/requirements | security + deployment + adapter/learning boundaries | TEST-011, TEST-061–069, TEST-074–099 | TASK-003 supplies partial SEC-001/003/004/006/007 evidence for path-free bounded transport, explicit verified-copy/fail-closed direct policy, capability/job/correlation/hash/length binding, capability-root containment, versioned deny-all decisions, content-minimized audit, governed derivative contracts, and sanitized failures; unrelated ambient-resource exclusion, deployment policy/repositories, durable audit/store adapters, identity/session, OS sandbox, resource limits, and retention enforcement remain pending |
