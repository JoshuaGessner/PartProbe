...
| REQ-F-021–024 | Detailed CAD/feature/setup requirements | geometry/feature engines and worker | TEST-021–039 | TASK-003 kernel-neutral contracts, explicit identity-bound verified-copy plus exact Unix descriptor/Windows HANDLE direct transport, capability-root local intake, worker-side source verification, and provisional STEP basic-property spike; authoritative analysis and feature/setup evidence pending |
...
| REQ-NF-001–022 | Nonfunctional requirements | ADRs, security, deployment, quality, replay and resource budgets | TEST-001/002/014, TEST-007, TEST-008, TEST-011–013, TEST-019–030, TEST-040–099 | TASK-001/002 supply three-OS calculation, replay, and missing-data evidence; TASK-003 supplies partial TEST-008/011/019/021/023/030 evidence for a bounded worker, capability-root containment, explicit verified-copy transport, exact Unix descriptor/Windows HANDLE allowlisting, identity/type/hash/length/quota revalidation, deny-by-default authorization/audit, cancellation/forced termination, Unix CPU/file/process-group limits, Linux memory limits, Windows CPU/memory/one-process Job containment, plus Apple Silicon byte-stream OCCT evidence. Three-OS Checkpoint 18 CI plus network/filesystem, macOS memory, hostile Unix descendant, aggregate-output, and broader gates remain pending |
...
| SEC-001–014 | Security model/requirements | security + deployment + adapter/learning boundaries | TEST-011, TEST-061–069, TEST-074–099 | TASK-003 supplies partial SEC-001/003/004/006/007 evidence for path-free bounded transport, explicit verified-copy and exact Unix/Windows direct modes, ambient descriptor/HANDLE exclusion, capability/job/correlation/hash/length binding, capability-root containment, versioned deny-all decisions, content-minimized audit, governed derivative contracts, and sanitized failures; deployment policy/repositories, durable audit/store adapters, identity/session, OS sandbox, resource limits, and retention enforcement remain pending |
...
| GEO-001–015 | CAD/model requirements | geometry architecture | TEST-021–030 | Partial GEO-001/006 evidence preserves an open source grant, exact hash/length, verified immutable worker bytes, and byte-stream parsing for two mesh fixtures, one analytic same-kernel STEP cube, and one adversarial STEP fixture; independent exact corpus and authoritative snapshots pending |
...
| TEST-001–099 | Quality strategy and specialized plans | `docs/06-quality` | Self-audit + future executable suites | TEST-001 and partial TEST-002/003/008/011/014/019/021/023/030 have executable evidence; TASK-003 has a 96-test three-OS Checkpoint 17 direct-resource baseline and a locally green 99-test macOS Checkpoint 18 resource profile awaiting three-OS CI, plus focused Apple Silicon ABI-v3 native evidence, while remaining acceptance suites stay planned |
