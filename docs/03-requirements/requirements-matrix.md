...
| REQ-NF-001–022 | Nonfunctional requirements | ADRs, security, deployment, quality, replay and resource budgets | TEST-001/002/014, TEST-007, TEST-008, TEST-011–013, TEST-019–030, TEST-040–099 | TASK-001/002 supply three-OS calculation, replay, and missing-data evidence; TASK-003 supplies partial TEST-008/011/019/021/023/030 three-OS evidence for a bounded worker, capability-root containment, explicit verified-copy transport, Unix descriptor allowlisting and unrelated-resource exclusion, identity/type/hash/length/quota revalidation, deny-by-default authorization/audit, cancellation and forced termination, plus Apple Silicon byte-stream OCCT evidence. Windows HANDLE whitelisting, OS resource isolation, and broader gates remain pending |
