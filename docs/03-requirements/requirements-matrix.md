...
| SEC-001–014 | Security model/requirements | security + deployment + adapter/learning boundaries | TEST-011, TEST-061–069, TEST-074–099 | TASK-003 supplies partial SEC-001/004 evidence for path-free bounded worker transport, capability-root containment, final-link rejection, and sanitized failures; application authorization/audit, OS sandbox, resource limits, and controlled-store evidence remain pending |
