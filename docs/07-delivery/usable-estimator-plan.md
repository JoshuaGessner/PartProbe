...
| VIS-3 model/stock review — In Progress | **Model & stock** opens the source-bound native viewport, standard views, textual model/proposal evidence, warnings, and provenance; scene tree, edges/stock toggles, and governed stock remain planned | Contract-v12 command/permission parity and initial keyboard/textual evidence pass locally; GPU-unavailable fallback, complete screen-reader acceptance, remaining controls, and packaged Apple-Silicon smoke remain |
