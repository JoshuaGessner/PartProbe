...
Status: **In Progress.** Calculation/rate mechanics, a substantial worker/geometry spike, GUI-2 through GUI-5's bounded Apple-Silicon STEP-to-estimate path, and separate verified developer-runtime assembly on Apple Silicon and Ubuntu x86_64 now have executable evidence. Interviews, shop calibration, the remaining durable UI/accessibility/viewer/PDF spike, persistence spike, representative private-fixture governance, Windows native construction, ADR closure, supported-platform signed native packaging, and accuracy/performance budgets remain open.
