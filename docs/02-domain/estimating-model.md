...
Each node stores value, unit/currency, inputs, rule ID/version, intermediate values, rounding policy, provenance, warnings, confidence reasons, and override chain. Edges are acyclic. Published estimates reference immutable node-result snapshots.
